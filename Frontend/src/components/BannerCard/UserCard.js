...
//               <button type="submit" class="btn btn-link" id={JSON.stringify(bannerDetails)} onClick={(e) => { this.addToCart(e, bannerDetails) }}/*  onClick={AddtoCart} */ style={{  }} >
//                 Add to Cart{/* <i id={JSON.stringify(bannerDetails)} style={{ color: 'red' }} class="far fa-trash-alt"></i> */}
    ...
    return (
      ...
      <div class="col-sm-4" >
        ...
        <hr/>
          <div class="card-body">
          <h5 class="card-title">&nbsp;&nbsp;&nbsp;&nbsp;{bannerDetails.name}<span class="card-text" style={{ fontSize: "15px", float: "right" }}>${bannerDetails.price}&nbsp;&nbsp;&nbsp;&nbsp;</span></h5>
          <h5 class="card-title">&nbsp;&nbsp;&nbsp;&nbsp;{bannerDetails.description}<span class="card-text" style={{ fontSize: "15px", float: "right" }}>1 {bannerDetails.unit}&nbsp;&nbsp;&nbsp;&nbsp;</span></h5>
            <p class="card-text" style={{ fontSize: "15px", margin: "20px" }}>
              <div >
                <label>Quantity</label>
                <div style={{float:"right"}}>
              ...
              <button type="submit" class="btn btn-link" id={JSON.stringify(bannerDetails)} /*  onClick={AddtoCart} */ style={{  }} >
                ...
                <button className="btn  btn-success" id={JSON.stringify(bannerDetails)} onClick={(e) => { this.addToCart(e, bannerDetails) }} >Add to Cart</button>
              </button>
              </div>              
              {/* <form className="form-inline">
                                    <div className="form-group mx-sm-3 mb-2">
